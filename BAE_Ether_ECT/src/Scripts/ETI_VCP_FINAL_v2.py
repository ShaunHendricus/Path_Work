...
class ETi300:
    ...
    def __init__(self, com_port: str = 'COM4', baud_rate: int = None, timeout: float = None):
        ...
        self.channel_configs = {
            0: ChannelConfig(100000, 0, 200, 500, 1000, 4000), #frequency, phase, gainx, gainy,hp filter,lp filter
            1: ChannelConfig(300000, 0, 100, 700, 10000, 40000),
            2: ChannelConfig(20000, 200000, 300, 400, 5000, 4000),
            3: ChannelConfig(15000, 300000, 300, 500, 4600, 4000)
        }
