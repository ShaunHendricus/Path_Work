...
class ETi300:
    ...
    def __init__(self, com_port: str = 'COM4', baud_rate: int = None, timeout: float = None):
        ...
        self.channel_configs = {
            0: ChannelConfig(800000, 0, 0, 0, 10000, 40000),
            1: ChannelConfig(56000, 180000, 600, 900, 400, 4000),
            2: ChannelConfig(20000, 200000, 600, 900, 400, 4000),
            3: ChannelConfig(15000, 300000, 600, 900, 400, 4000)
        }
